...
;
    ...
    function getDrawable(index, selected) {
        return new WatchUi.Text( { :text=>getValue(index).format("%d"), :color=>Graphics.COLOR_WHITE, :font=> fontOpts, :locX =>WatchUi.LAYOUT_HALIGN_CENTER, :locY=>WatchUi.LAYOUT_VALIGN_CENTER } );
    }
