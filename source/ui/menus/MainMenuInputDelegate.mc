  ...
  function onSelect(item as Ui.MenuItem) as Void {
    switch (Menus.itemId(item)) {
      ...
      case :ReminderTimer_MenuID :
        Ui.pushView(new NumPicker(Ui.loadResource(Rez.Strings.reminderTimer_MenuLabel).toString(), Ui.loadResource(Rez.Strings.reminderTimer_StorageID) as String),
                    new NumPickerDelegate(Ui.loadResource(Rez.Strings.reminderTimer_StorageID) as String),
                    Ui.SLIDE_LEFT);
        break;
